        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-white/35">Light and dark are fully theme-painted; contrast is verified in both.</p>
            </div>
          ...
          <div className="border-t border-white/8 pt-6 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-white/35">Compact fits roughly 40% more offers per screen.</p>
            </div>
          ...
          <div className="border-t border-white/8 pt-6 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-white/35">Removes streaming and skeleton animation.</p>
            </div>
          ...
          <div className="border-t border-white/8 pt-6 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-white/35">Shows the exact refresh time rather than a relative age.</p>
            </div>
            <Toggle on={fullFreshness} onToggle={() => setFull(v => !v)} />
          </div>

          <div className="border-t border-white/8 pt-6 rounded border border-sky-500/20 p-4" style={{ backgroundColor: "rgba(14,165,233,0.07)" }}>
