  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
      ...
      <section className="mt-12 grid gap-6 sm:grid-cols-2">
        <Link href={ROUTES.SEARCH} className="group block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 rounded-xl">
        ...
        <Link href={ROUTES.ASSISTANT} className="group block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 rounded-xl">
          <Card className="h-full transition-shadow group-hover:shadow-md">
            <CardHeader>
              <h2 className="text-xl font-semibold text-text-primary">
